...
apt-get -qq update -y
apt-get -qq install wireshark pip mongodb-org=3.2.11 tcpdump virtualbox python python-pip python-dev libvirt-dev libffi-dev libssl-dev libxml2-dev libxslt1-dev libjpeg-dev libcap2-bin python-dnspython autoconf libtool libjansson-dev libmagic-dev libssl-dev -y
